...
<div style="display: none;">A request to reset password was received from your School Account</div>
                ...
                <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; width: 600px;" width="600" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                            <a href="https://www.school.layouteam.com/landing-page" style="padding: 10px;background: black;
    border-radius: 5px;
    display: block;">
                                <img src="https://www.school.layouteam.com/images/logo.png" width="100%" alt="Vuexy Admin" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                            </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                                        ...
                                        <p style="margin: 0 0 24px;">
                                            ...
                                            <span style="font-weight: 600;">School</span> Account -
                                        ...
                                        <a href="{{env('FRONT_APP_URL')}}/reset_password/{{$email}}/{{$code}}" style="display: block; font-size: 14px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">{{env('FRONT_APP_URL')}}/reset_password/</a>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;" bgcolor="rgba(115, 103, 240, var(--bg-opacity))">
                                                    <a href="{{env('FRONT_APP_URL')}}/reset-password/{{$email}}/{{$code}}/" style="display: block; background: #000000; color: yellow;  font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; border-radius: 25px; text-decoration: none;">Reset Password &rarr;</a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <p style="margin: 0;">
                                            ...
                                            contact us at
                                            <a href="mailto:info@School.com" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">info@School.com</a>
                                        </p>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                        ...
                                        <p style="margin: 0 0 16px;">
                                            ...
                                            <a href="mailto:info@School.com" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">let us know</a>.
                                        </p>
                                        <p style="margin: 0 0 16px;">Thanks, <br>The School Team</p>
                                    </td>
                                </tr>
                                <tr>
