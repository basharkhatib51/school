...
export default {
  ...
  computed: {
    ...
    Element() { return this.$store.getters['fee/GetElement'] },
  },
  watch: {
  ...
  methods: {
    ...
    getData() {
      this.$store.dispatch('fee/GetElement', this.$route.params.fee).then(() => {
        this.data = this.Element
      })
    },
    update() {
      this.errors = []
      this.$store.dispatch('fee/Update', this.data).then(() => {
      }).catch(error => {
