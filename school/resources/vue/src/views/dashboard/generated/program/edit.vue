...
export default {
  ...
  computed: {
    ...
    Element() { return this.$store.getters['program/GetElement'] },
  },
  watch: {
  ...
  methods: {
    ...
    getData() {
      this.$store.dispatch('program/GetElement', this.$route.params.program).then(() => {
        this.data = this.Element
      })
    },
    update() {
      this.errors = []
      this.$store.dispatch('program/Update', this.data).then(() => {
      }).catch(error => {
