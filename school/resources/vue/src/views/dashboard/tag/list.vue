<template>
  <div>
    ...
    <b-row>
      ...
      >
        <b-button
          v-if="haveAccess(['Show Tag Trash','Show Tag Trash Owner'])"
    ...
    >
      ...
      >
        ...
        <template #cell(options)="data">
          <div class="w-max">
            <router-link
              v-if="haveAccess('Update Tag')||haveElementAccess('Update Tag Owner',data.item.created_by_id)"
              class="text-success"
            ...
            <a
              v-if="haveAccess('Delete Tag')||haveElementAccess('Delete Tag Owner',data.item.created_by_id)"
